...
/**
 * TimeSpinner spinning time in format HH:mm
 * Credit to stack overflow user James_D https://stackoverflow.com/users/2189127/james-d
 *
 * @author James_D, Philipp Seidel
 * @version 1.0
 */
